...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || '∆RY∆N-TECH',
    botOwner: process.env.BOT_OWNER || '∆RY∆N-TECH',
    ownerNumber: process.env.OWNER_NUMBER || '255637518095',
    author: process.env.AUTHOR || 'GlobalTechInfo',
    packname: process.env.PACKNAME || '∆RY∆N-TECH',
    ...
    // Links
    channelLink: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbBk9IKAjPXIih13Q33d',
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/GlobalTechInfo/∆RY∆N-TECH/archive/refs/heads/main.zip',
